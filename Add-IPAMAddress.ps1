...
#   - The idea is to use this script to create addresses from AD, Azure, AWS, your local hypervisor or other by using CSV-export or PowerShell-objects with direct piping
#
